...
def run(args):
    ...
    #v5 update: 4 camera poses
    def rotate_camtoworlds_v2(angle_x, angle_y, angle_z):
    ...
    cam = [rotate_camtoworlds_v2(angle_x, angle_y, angle_z) for angle_x, angle_y, angle_z in poses]
